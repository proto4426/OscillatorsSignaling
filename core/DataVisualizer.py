...
class DataVisualizer:
    """
    Chart plotting for exchange API data
    """
    ...
    def visualize(self, filename, datetime_from, datetime_to, datetime_interval, from_symbol, to_symbol, exchange):
        ...
        # plot candlesticks
        candlestick_width = self.get_candlestick_width(datetime_interval)
